...
List<Video> getFakeVideos() {
  return [
    Video(
        ...
        keywords: "clay,face,janet blake,sculpture", categoryId: '', videoUrl: '', createdBy: '', category: '', fileNameOriginal: '', image: '', cropped: '', duration: '', popularity: '', id: ''),
    ...
    Video(
        ...
        keywords: "baton,dance,fire,performer,poi", categoryId: '', videoUrl: '', createdBy: '', category: '', fileNameOriginal: '', image: '', cropped: '', duration: '', popularity: '', id: ''),
    ...
    Video(
        ...
        keywords: "computer,design,graphic,tablet,youth", categoryId: '', videoUrl: '', createdBy: '', category: '', fileNameOriginal: '', image: '', cropped: '', duration: '', popularity: '', id: ''),
